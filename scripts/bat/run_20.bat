...
set "base_cmd=%python_executable% ../C_command_line_main.py --data_path C:\Users\pnthu\PycharmProjects\check_btstrp_bruteforce_final\data\test.csv --result_path C:\Users\pnthu\PycharmProjects\check_btstrp_bruteforce_final\results --result_file 9_20_2017.csv"
