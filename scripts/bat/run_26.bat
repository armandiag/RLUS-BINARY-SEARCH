...
set base_cmd=%python_executable% ../C_command_line_main.py --data_path "C:\Users\pnthu\PycharmProjects\check_btstrp\data\9_26_2017.csv" --result_path "C:\Users\pnthu\PycharmProjects\check_btstrp\results --result_file 9_26_2017.csv"
