...
base_cmd="$python_executable /app/C_command_line_main.py --data_path /app/data/9_23_2017.csv --result_path /app/results --result_file 9_23_2017.csv"

# Log file path
log_file="/app/logs/run_23_time_log.txt"
